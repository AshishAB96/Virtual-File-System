...
void man(char *name)
{
    ...
    else if(strcmp(name, "write") == 0)
    {
        ...
        printf("Usage: write Fiel_Name \n After this enter thr data taht we want to write \n");
    ...
    else if(strcmp(name,"truncate") == 0)
    {
        ...
        printf("Usage : state File_Descripter\n");
    }
...
void DisplayHelp()
{
    ...
    printf("fstat : To Display information of fie using file descriptor \n");
...
void CreateDILB()
{
    ...
    printf("DILB creted Successfully \n");
}
    ...
    while(1)
    {
        ...
        else if(count == 3)
        {
            ...
            else if(strcmp(command[0],"open") == 0)
            {
                ...
                if(ret >= 0)
                {
                    printf("Fie is Successfully opened with fiel Descripter : %d\n",ret);
                }
                if(ret == -1)
                {
                    printf("ERROR : Incorrect Parameters \n");
